...
export default function NovoPlacanjeWizard() {
  ...
  // Verification code generated by ApprovePendingAction
  ...
  async function handleFormSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      const code = await approvePendingAction(result.action_id)
      ...
      <div className="max-w-lg space-y-6">
        <div className="card text-center py-10 space-y-4">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center pt-2">
            ...
            <button
              onClick={() => { setStep('form'); setPendingIntent(null); setVerifyCode(''); setFormError(null); setCompletedPayment(null); setAttemptCount(0); setLockedOut(false) }}
